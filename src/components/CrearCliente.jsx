        ...
        <div className="card2">
          <form className="form" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="field">
              ...
              <input className="input-field" placeholder="Nombre" type="text" {...register('nombre', {
                required: true
              })}/>
            ...
            <div className="field">
              ...
              <input class="input-field" placeholder="Apellido" type="apellido" /*COMPLETAR LA FUNCION*/ />
            </div>
            ...
            <div className="field">
              ...
              <input class="input-field" placeholder="Email" type="email" {...register('mail', {
                required: true,
                pattern: /^(([^<>()\[\]\.,;:\s@\”]+(\.[^<>()\[\]\.,;:\s@\”]+)*)|(\”.+\”))@(([^<>()[\]\.,;:\s@\”]+\.)+[^<>()[\]\.,;:\s@\”]{2,})$/
              })} />
